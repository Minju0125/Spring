...
<%@page import="kr.or.ddit.calculate.controller.NumericOperatorType"%>
...
<script src="${pageContext.request.contextPath}/resources/js/app/calculate/calForm_case6.js"></script>
</head>
<body>
