...
/**
 * 로그인된(sessionScope 에 authId 가 있으면) 사용자가 요청을 발생시킨 경우, 
 * Principal 객체를 생성하고, 현재 요청을 변경하여 principal 을 setting 하려함. (Adapter[Wrapper] requset).
 *
 */
@Slf4j
public class GeneratePrincipalFilter implements Filter{@Override
